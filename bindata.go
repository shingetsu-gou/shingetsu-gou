...
// file/message-ja.txt
// file/motd.txt
// template/2ch_error.txt
// template/delete_file.txt
// template/delete_record.txt
// template/edit_tag.txt
// template/footer.txt
// template/gateway_link.txt
// template/header.txt
// template/index_list.txt
// template/jump.txt
// template/list_item.txt
// template/menubar.txt
// template/new_element_form.txt
// template/page_navi.txt
// template/paragraph.txt
// template/post_form.txt
// template/record.txt
// template/remove_file_form.txt
// template/rss1.txt
// template/search_form.txt
// template/status.txt
// template/thread_bottom.txt
// template/thread_tags.txt
// template/thread_top.txt
// template/top.txt
// www/00default.css
// www/00initialize.js
// www/20jump.js
...
// template2ch_errorTxt reads file data from disk. It returns an error on failure.
func template2ch_errorTxt() (*asset, error) {
	path := "/home/dame/ddd/prog/go/src/github.com/shinGETsu-gou/shingetsu-gou/template/2ch_error.txt"
	name := "template/2ch_error.txt"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// templateDelete_fileTxt reads file data from disk. It returns an error on failure.
func templateDelete_fileTxt() (*asset, error) {
	path := "/home/dame/ddd/prog/go/src/github.com/shinGETsu-gou/shingetsu-gou/template/delete_file.txt"
	name := "template/delete_file.txt"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// templateDelete_recordTxt reads file data from disk. It returns an error on failure.
func templateDelete_recordTxt() (*asset, error) {
	path := "/home/dame/ddd/prog/go/src/github.com/shinGETsu-gou/shingetsu-gou/template/delete_record.txt"
	name := "template/delete_record.txt"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// templateEdit_tagTxt reads file data from disk. It returns an error on failure.
func templateEdit_tagTxt() (*asset, error) {
	path := "/home/dame/ddd/prog/go/src/github.com/shinGETsu-gou/shingetsu-gou/template/edit_tag.txt"
	name := "template/edit_tag.txt"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// templateFooterTxt reads file data from disk. It returns an error on failure.
func templateFooterTxt() (*asset, error) {
	path := "/home/dame/ddd/prog/go/src/github.com/shinGETsu-gou/shingetsu-gou/template/footer.txt"
	name := "template/footer.txt"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// templateGateway_linkTxt reads file data from disk. It returns an error on failure.
func templateGateway_linkTxt() (*asset, error) {
	path := "/home/dame/ddd/prog/go/src/github.com/shinGETsu-gou/shingetsu-gou/template/gateway_link.txt"
	name := "template/gateway_link.txt"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// templateHeaderTxt reads file data from disk. It returns an error on failure.
func templateHeaderTxt() (*asset, error) {
	path := "/home/dame/ddd/prog/go/src/github.com/shinGETsu-gou/shingetsu-gou/template/header.txt"
	name := "template/header.txt"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// templateIndex_listTxt reads file data from disk. It returns an error on failure.
func templateIndex_listTxt() (*asset, error) {
	path := "/home/dame/ddd/prog/go/src/github.com/shinGETsu-gou/shingetsu-gou/template/index_list.txt"
	name := "template/index_list.txt"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// templateJumpTxt reads file data from disk. It returns an error on failure.
func templateJumpTxt() (*asset, error) {
	path := "/home/dame/ddd/prog/go/src/github.com/shinGETsu-gou/shingetsu-gou/template/jump.txt"
	name := "template/jump.txt"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// templateList_itemTxt reads file data from disk. It returns an error on failure.
func templateList_itemTxt() (*asset, error) {
	path := "/home/dame/ddd/prog/go/src/github.com/shinGETsu-gou/shingetsu-gou/template/list_item.txt"
	name := "template/list_item.txt"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// templateMenubarTxt reads file data from disk. It returns an error on failure.
func templateMenubarTxt() (*asset, error) {
	path := "/home/dame/ddd/prog/go/src/github.com/shinGETsu-gou/shingetsu-gou/template/menubar.txt"
	name := "template/menubar.txt"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// templateNew_element_formTxt reads file data from disk. It returns an error on failure.
func templateNew_element_formTxt() (*asset, error) {
	path := "/home/dame/ddd/prog/go/src/github.com/shinGETsu-gou/shingetsu-gou/template/new_element_form.txt"
	name := "template/new_element_form.txt"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// templatePage_naviTxt reads file data from disk. It returns an error on failure.
func templatePage_naviTxt() (*asset, error) {
	path := "/home/dame/ddd/prog/go/src/github.com/shinGETsu-gou/shingetsu-gou/template/page_navi.txt"
	name := "template/page_navi.txt"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// templateParagraphTxt reads file data from disk. It returns an error on failure.
func templateParagraphTxt() (*asset, error) {
	path := "/home/dame/ddd/prog/go/src/github.com/shinGETsu-gou/shingetsu-gou/template/paragraph.txt"
	name := "template/paragraph.txt"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// templatePost_formTxt reads file data from disk. It returns an error on failure.
func templatePost_formTxt() (*asset, error) {
	path := "/home/dame/ddd/prog/go/src/github.com/shinGETsu-gou/shingetsu-gou/template/post_form.txt"
	name := "template/post_form.txt"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// templateRecordTxt reads file data from disk. It returns an error on failure.
func templateRecordTxt() (*asset, error) {
	path := "/home/dame/ddd/prog/go/src/github.com/shinGETsu-gou/shingetsu-gou/template/record.txt"
	name := "template/record.txt"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// templateRemove_file_formTxt reads file data from disk. It returns an error on failure.
func templateRemove_file_formTxt() (*asset, error) {
	path := "/home/dame/ddd/prog/go/src/github.com/shinGETsu-gou/shingetsu-gou/template/remove_file_form.txt"
	name := "template/remove_file_form.txt"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// templateRss1Txt reads file data from disk. It returns an error on failure.
func templateRss1Txt() (*asset, error) {
	path := "/home/dame/ddd/prog/go/src/github.com/shinGETsu-gou/shingetsu-gou/template/rss1.txt"
	name := "template/rss1.txt"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// templateSearch_formTxt reads file data from disk. It returns an error on failure.
func templateSearch_formTxt() (*asset, error) {
	path := "/home/dame/ddd/prog/go/src/github.com/shinGETsu-gou/shingetsu-gou/template/search_form.txt"
	name := "template/search_form.txt"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// templateStatusTxt reads file data from disk. It returns an error on failure.
func templateStatusTxt() (*asset, error) {
	path := "/home/dame/ddd/prog/go/src/github.com/shinGETsu-gou/shingetsu-gou/template/status.txt"
	name := "template/status.txt"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// templateThread_bottomTxt reads file data from disk. It returns an error on failure.
func templateThread_bottomTxt() (*asset, error) {
	path := "/home/dame/ddd/prog/go/src/github.com/shinGETsu-gou/shingetsu-gou/template/thread_bottom.txt"
	name := "template/thread_bottom.txt"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// templateThread_tagsTxt reads file data from disk. It returns an error on failure.
func templateThread_tagsTxt() (*asset, error) {
	path := "/home/dame/ddd/prog/go/src/github.com/shinGETsu-gou/shingetsu-gou/template/thread_tags.txt"
	name := "template/thread_tags.txt"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// templateThread_topTxt reads file data from disk. It returns an error on failure.
func templateThread_topTxt() (*asset, error) {
	path := "/home/dame/ddd/prog/go/src/github.com/shinGETsu-gou/shingetsu-gou/template/thread_top.txt"
	name := "template/thread_top.txt"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// templateTopTxt reads file data from disk. It returns an error on failure.
func templateTopTxt() (*asset, error) {
	path := "/home/dame/ddd/prog/go/src/github.com/shinGETsu-gou/shingetsu-gou/template/top.txt"
	name := "template/top.txt"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
var _bintree = &bintree{nil, map[string]*bintree{
	...
	"template": {nil, map[string]*bintree{
		"2ch_error.txt":        {template2ch_errorTxt, map[string]*bintree{}},
		"delete_file.txt":      {templateDelete_fileTxt, map[string]*bintree{}},
		"delete_record.txt":    {templateDelete_recordTxt, map[string]*bintree{}},
		"edit_tag.txt":         {templateEdit_tagTxt, map[string]*bintree{}},
		"footer.txt":           {templateFooterTxt, map[string]*bintree{}},
		"gateway_link.txt":     {templateGateway_linkTxt, map[string]*bintree{}},
		"header.txt":           {templateHeaderTxt, map[string]*bintree{}},
		"index_list.txt":       {templateIndex_listTxt, map[string]*bintree{}},
		"jump.txt":             {templateJumpTxt, map[string]*bintree{}},
		"list_item.txt":        {templateList_itemTxt, map[string]*bintree{}},
		"menubar.txt":          {templateMenubarTxt, map[string]*bintree{}},
		"new_element_form.txt": {templateNew_element_formTxt, map[string]*bintree{}},
		"page_navi.txt":        {templatePage_naviTxt, map[string]*bintree{}},
		"paragraph.txt":        {templateParagraphTxt, map[string]*bintree{}},
		"post_form.txt":        {templatePost_formTxt, map[string]*bintree{}},
		"record.txt":           {templateRecordTxt, map[string]*bintree{}},
		"remove_file_form.txt": {templateRemove_file_formTxt, map[string]*bintree{}},
		"rss1.txt":             {templateRss1Txt, map[string]*bintree{}},
		"search_form.txt":      {templateSearch_formTxt, map[string]*bintree{}},
		"status.txt":           {templateStatusTxt, map[string]*bintree{}},
		"thread_bottom.txt":    {templateThread_bottomTxt, map[string]*bintree{}},
		"thread_tags.txt":      {templateThread_tagsTxt, map[string]*bintree{}},
		"thread_top.txt":       {templateThread_topTxt, map[string]*bintree{}},
		"top.txt":              {templateTopTxt, map[string]*bintree{}},
	}},
