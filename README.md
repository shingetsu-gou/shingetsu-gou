...
3. Gou can try to open port by uPnP and NAT-PMP. You can disable this function by setting enable_nat:true in [Gateway]  in saku.ini, which is false by default, but is true in attached saku.ini in binary.
